...
const GoodFithExam = () => {
    ...
    const fetchEhrData = async () => {
        ...
        try {
            const response = await fetch(`${BASE_URL}faith`, {
                method: 'GET',
                headers: {
            ...
            if (!response.ok) {
                throw new Error('Failed to fetch faith data');
            }
    ...
    const handleDelete = async (id) => {
        ...
        try {
            const response = await fetch(`${BASE_URL}faith-delete/${id}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
    ...
    const handleAddOrUpdate = async (values) => {
        ...
        const url = isEditMode ? `${BASE_URL}faith-update/${currentEhr.id}` : `${BASE_URL}faith-store`;
